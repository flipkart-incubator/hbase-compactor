...
public class CompactionManager {
    ...
    public final void checkAndStart() {
         ...
         */
        while ((!compactionSchedule.isPrompt() && !ScheduleUtils.hasTimedOut(compactionSchedule) && ScheduleUtils.canStart(compactionSchedule)) || (compactionSchedule.isPrompt() && !ScheduleUtils.hasExpired(compactionSchedule, Instant.now()))){
            try {
